...
export class ConnectService {
  ...
  public getRandomUser() {
    ...
    return this.http.get('http://localhost:8080/connect', {
      headers,
      responseType: 'text'
    });
  }
  ...
  public acceptUser(username: string) {
    const headers = this.headersService.getHeaders();
    return this.http.post('http://localhost:8080/match', username, {
      headers,
      responseType: 'text'
    });
  }
  ...
  public rejectUser(username: string) {
    const headers = this.headersService.getHeaders();
    return this.http.delete('http://localhost:8080/match/' + username, {
      headers,
      responseType: 'text'
    });
  }
