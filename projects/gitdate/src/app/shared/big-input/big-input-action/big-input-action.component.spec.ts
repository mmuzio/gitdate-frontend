...
@Component({
  selector: 'ngrxtmp-host-for-test',
  template: ''
})
class HostComponent {
  actionHandler = () => {};
...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<ngrxtmp-big-input-action></ngrxtmp-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<ngrxtmp-big-input-action [disabled]="true"></ngrxtmp-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<ngrxtmp-big-input-action fontSet="fas" fontIcon="fa-trash"></ngrxtmp-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<ngrxtmp-big-input-action label="delete"></ngrxtmp-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<ngrxtmp-big-input-action (action)="actionHandler()"></ngrxtmp-big-input-action>`;
    fixture = createHostComponent(template);
